    ...
    <svg viewBox="0 0 400 500" class="cbc-svg" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <linearGradient id="body-gradient-w" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#ffffff"/><stop offset="45%" stop-color="#e4eefa"/><stop offset="100%" stop-color="#a9c3dd"/>
        </linearGradient>
    ...
    <svg viewBox="0 0 400 500" class="cbc-svg" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <linearGradient id="dryer-body-d" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#ffffff"/><stop offset="45%" stop-color="#faf0e0"/><stop offset="100%" stop-color="#e0bd8c"/>
        </linearGradient>
